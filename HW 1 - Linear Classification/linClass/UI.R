...
shinyUI(fluidPage(
  sidebarLayout(
    ...
    mainPanel(
      h2("K =3 Classification"),
      p("This is an interactive app that lets you play with the classification of three types of animals.",
      ...
      p("To the side you may change the draws of the three classes of animals."),
